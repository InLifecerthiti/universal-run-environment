...
[uninstalled] [3.0.8 ] wrapper           standard-3.0.8      Provide OS integration
[uninstalled] [3.0.8 ] obr               standard-3.0.8      Provide OSGi Bundle Repository (OBR) support
[uninstalled] [3.0.8 ] config            standard-3.0.8      Provide OSGi ConfigAdmin support
[uninstalled] [3.0.8 ] region            standard-3.0.8      Provide Region commands
[uninstalled] [7.5.4.v20111024] jetty             standard-3.0.8      Provide Jetty engine support
[uninstalled] [3.0.8 ] http              standard-3.0.8      Implementation of the OSGI HTTP Service
[uninstalled] [3.0.8 ] http-whiteboard   standard-3.0.8      Provide HTTP Whiteboard pattern support
[uninstalled] [3.0.8 ] war               standard-3.0.8      Turn Karaf as a full WebContainer
[uninstalled] [3.0.8 ] deployers         standard-3.0.8      Provide Karaf deployer
[uninstalled] [3.0.8 ] kar               standard-3.0.8      Provide KAR (KARaf archive) support
[uninstalled] [3.0.8 ] webconsole-base   standard-3.0.8      Base support of the Karaf WebConsole
[uninstalled] [3.0.8 ] webconsole        standard-3.0.8      Karaf WebConsole for administration and monitoring
[uninstalled] [3.0.8 ] ssh               standard-3.0.8      Provide a SSHd server on Karaf
...
Maven builds the web application, web-3.0.8.war, and
